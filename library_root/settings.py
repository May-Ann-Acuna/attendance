...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost",
    "http://127.0.0.1",
    "https://aulic-mimi-nondisingenuously.ngrok-free.dev",  # note HTTPS!
]


ALLOWED_HOSTS = ['192.168.1.12', ' https://aulic-mimi-nondisingenuously.ngrok-free.dev']  # Default allowed host (your machine IP)

# For local development and testing from other devices (or tunnels like ngrok),
# allow all hosts when DEBUG is True. This is safe for local development only.
if DEBUG:
    ALLOWED_HOSTS = ['*']
